...
class thriftVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by thriftParser#starNamespace.
    def visitStarNamespace(self, ctx: thriftParser.StarNamespaceContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by thriftParser#explicitNamespace.
    def visitExplicitNamespace(self, ctx: thriftParser.ExplicitNamespaceContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by thriftParser#cppNamespace.
    def visitCppNamespace(self, ctx: thriftParser.CppNamespaceContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by thriftParser#phpNamespace.
    def visitPhpNamespace(self, ctx: thriftParser.PhpNamespaceContext):
        return self.visitChildren(ctx)
    ...
    def visitException_(self, ctx: thriftParser.Exception_Context):
        return self.visitChildren(ctx)
